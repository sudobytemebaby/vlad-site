	...
	import { type VariantProps, tv } from "tailwind-variants";
		...
		variants: {
			variant: {
				...
				outline: "border-border bg-background hover:bg-[var(--accent)] hover:text-[var(--accent-foreground)] dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-[var(--accent)] aria-expanded:text-[var(--accent-foreground)]",
				secondary: "bg-secondary text-secondary-foreground hover:opacity-90 aria-expanded:opacity-90",
				ghost: "hover:bg-[var(--accent)] hover:text-[var(--accent-foreground)] dark:hover:bg-[var(--accent)] aria-expanded:bg-[var(--accent)] aria-expanded:text-[var(--accent-foreground)]",
