...
<section id="contacts" class="py-12 sm:py-16 lg:py-20 bg-background">
  <div class="max-w-6xl mx-auto px-4">
    ...
    <div class="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-4 sm:gap-8">
      <a href="tel:{placeholder.doctor.contacts.phoneRaw}" class="flex items-center gap-3 hover:text-primary transition-colors px-4 py-3 sm:p-0 rounded-xl sm:rounded-none bg-surface sm:bg-transparent">
